...
#define LED_MODULO_DEMO_STATUS_Pin GPIO_PIN_14
#define LED_MODULO_DEMO_STATUS_GPIO_Port GPIOB
#define LED_MODULO_DEMO_CONECTADO_Pin GPIO_PIN_15
#define LED_MODULO_DEMO_CONECTADO_GPIO_Port GPIOB
